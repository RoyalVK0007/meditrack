...
async function seedDemoData(req, res) {
  try {
    console.log('🌱 Starting demo data seeding (main routes)...');
...
async function clearAllData(req, res) {
  try {
    console.log('🧹 Starting database cleanup (main routes)...');
...
module.exports = { getPatients, addPatient, updatePatient, deletePatient, getVitals, addVital, getAllVitals, getBills, seedDemoData, generateBillPDF, clearAllData, markBillPaid, generateCSVReport };